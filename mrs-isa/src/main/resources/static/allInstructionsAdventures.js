        ...
        <div class="row d-flex justify-content-center">
            <div class="col-8 d-flex justify-content-center">
                <div>
                    ...
                    <div v-for="(item, index) in adventures" v-if="index < 10">
...
data() {
        ...
        adventures:[
            ...
            },
            {
                ...
                cancelCondition : [{days:5, double:30},{days:30, double:5}],
                additionalServices :["prevoz do podnozja", "dorucak u kampu", "stapovi za penjanje"],
            ...
            {
                name : "Planinarenje na Zlatiboru",
                address: {streetName:"Danila Kisa", serialNumber:"3", place:{postNumber: 22240, name:"Novi Pazar", country:"Srbija" }},
                description: 'Uzbudljvo putovanje za porodicu i prijatelje',

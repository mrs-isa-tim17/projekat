    ...
    <div  style="border:1px solid #31708E;background-color:#31708E;color:white; width: 1000px; display: inline-block;">
      <div class="row" >
        ...
        <div class="col-5">
          <br>
          <br>
          <label >Klijenti koji su trenutno na nekoj od avantura</label>
...
export default {
  name: "reservationForClient",
  components: {
    InstructorHeader,
//CalendarForOneCottage
    Multiselect,
    Datepicker},
  created() {
  ...
  methods: {
    ...
    selectedClient(){
      ...
      offerLabel.innerText = "Avantura: " + this.selectedClientData.offerName;
      this.calendarHeader = "Kalendar zauzeća za avanturu " + this.selectedClientData.offerName;
